...
:label: fig-cover
:alt: Applied Blockchain Build a Token Economy on Solana cover by Dr. Ernesto Lee
:width: 100%
:align: center
...
:::{grid-item-card} 🎓 Advanced Students
...
**[⬇ Course Syllabus — Applied Blockchain (PDF)](https://github.com/liquid-books/applied-blockchain-solana/raw/main/pdfs/syllabus.pdf)**
...
:::{grid-item-card} Chapter 0: What Is a Blockchain?
:link: ./chapters/ch00-what-is-a-blockchain.md
The ledger that nobody owns. From Mesopotamian clay tablets to distributed consensus — and the NAAT framework for evaluating every use case.
:::

:::{grid-item-card} Chapter 1: Your First Transaction in 20 Minutes
:link: ./chapters/ch01-first-transaction.md
...
:::{grid-item-card} Chapter 2: Design Your Token Like a Business
:link: ./chapters/ch02-design-your-token.md
Token design from first principles — utility, value capture, and the business model that makes a token worth holding.
:::

:::{grid-item-card} Chapter 3: Launch Your Token for Under $60
:link: ./chapters/ch03-launch-your-token.md
From concept to live mainnet token. The exact steps, tools, and costs of deploying an SPL token on Solana.
:::

:::{grid-item-card} Chapter 4: Tokenomics on a Napkin
:link: ./chapters/ch04-tokenomics.md
...
:::{grid-item-card} Chapter 6: Distribute It: Airdrops, Vesting, and Team Allocations
:link: ./chapters/ch06-distribute.md
...
:::{grid-item-card} Chapter 7: Give It Something to Do: Utility Without Code
:link: ./chapters/ch07-utility.md
...
:::{grid-item-card} Chapter 8: Your First Program, No Setup Required
:link: ./chapters/ch08-first-program.md
Introduction to Solana programs (smart contracts) using the Playground IDE — deploy your first on-chain logic in a browser.
:::

:::{grid-item-card} Chapter 9: Ownership as an Asset: NFTs and Memberships
:link: ./chapters/ch09-nfts-memberships.md
...
:::{grid-item-card} Chapter 10: Reading the Economy: On-Chain Analytics
:link: ./chapters/ch10-onchain-analytics.md
...
:::{grid-item-card} Chapter 11: Governance and Treasury
:link: ./chapters/ch11-governance-treasury.md
...
:::{grid-item-card} Chapter 12: Legal, Risk, and Running It for Real
:link: ./chapters/ch12-legal-risk.md
